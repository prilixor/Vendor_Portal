-- ----------------------------------------------------
-- Migration: 080_customer_order_prescriptions.sql
-- Target Database: customer_portal_db
-- Description: Customer-uploaded prescription image/PDF per order.
-- Execution: psql -d customer_portal_db -f 080_customer_order_prescriptions.sql
-- ----------------------------------------------------
